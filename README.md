...
## Responsibilities
My focus was mainly on the implementation of the enemy AI and everything related to that, such as the enemy base class, behavior trees and custom eqs tests.
